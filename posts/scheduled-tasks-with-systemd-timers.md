...
image:
  url: https://images.unsplash.com/photo-1501139083538-0139583c060f?ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&w=1600
  caption: Photo by [Aron Visuals](https://unsplash.com/@aronvisuals?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText)
tags: [Linux]
---

<!-- excerpt -->
Use a Linux system long enough and eventually you'll need to schedule a
recurring task. Of course the de facto scheduler is cron (and there's nothing
...
<!-- /excerpt -->
  ...
  - The ability to run "missed" tasks at next boot
...
For those unfamiliar, systemd is composed of "units". A unit is composed of one
or more files that define what they do and how they behave. Systemd units can
...
> [!NOTE]
> See the [systemd.service documentation](https://www.freedesktop.org/software/systemd/man/systemd.service.html) for additional information on services.
...
Here we can see the name of our service and its description at the top. Below
...
Now if we check the status again we should see the same info as before
...
Oct 31 08:56:18 Starscream composer[38204]:  10/10 [============================] 100% < 1 sec
...
`systemctl --user list-timers` right now we'll see a list of our currently
