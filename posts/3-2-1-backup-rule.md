...
image:
  url: /files/hard-drives.jpeg
tags: ['Backups']
---

<!-- excerpt -->
Too many people today don't back up their files. And of those that do, many
don't do it well. An easy way to remember a "safe" way to back up your data is
with the "3-2-1 Backup Rule" which goes like this:
...
If your backups aren't automated, there's a good chance you'll forget to run
