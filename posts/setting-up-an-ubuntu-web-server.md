...
image:
  url: https://images.unsplash.com/photo-1591808216268-ce0b82787efe?ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&h=1000
  caption: Photo by [Nathan Dumlao](https://unsplash.com/@nate_dumlao?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/server?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText)
tags: [Linux, Ubuntu]
---
...
The installation process is relatively straightforward, so I will not be going
...
installation and this won't be necessary. However, the following may be needed on
...
creating a non-privileged user account for yourself is recommended. Depending
...
Now that you have your LAMP stack set up you will need to configure it for
...
adding the Apache user and your user to this group and setting the setgid bit
...
### Set the setgid bit on all folders in your web directory:
...
in with your non-privileged user account and running `sudo su`.
