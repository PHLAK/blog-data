...
image:
  url: https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&w=1600
  caption: Photo by [Luca Bravo](https://unsplash.com/@lucabravo?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText)
tags: [Code, PHP]
---
...
This is fine if users only ever need to configure a few options. However, when
the specific options a user will require are unknown ahead of time the only way
...
configuration of complex objects, eliminate the need to pre-define options,
future-proof our configuration, require less code and (bonus) are type safe!
